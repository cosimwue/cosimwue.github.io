...
The Conflict Simulation Group at the University of Würzburg has collected most of the *Kriegsspiel* rule sets published between 1824 and 1914. We conduct research on the *Kriegsspiel* and its role in 19th century military thinking and education, and we organise *Kriegsspiel* games with reconstructed gaming materials, including for the first time in a long time large-scale scenarios on historical maps. Published results of our work can be found in the [publications](/2019/11/01/publications.html) section.
...
<iframe class="sozi" src="{{site.baseurl}}/assets/pres/procedere_pres.sozi.html" style="height:576px;width:1024px;border:none;"></iframe>
...
The largest games organised by the Conflict Simulation Group focus on what happened on the left flank of the Austrian Northern army at the Battle at Königgrätz (nowadays Hradec Králové in the Czech Republic) in 1866; on that part of the battlefield, the Prussian *Elbarmee* engaged with the army of Austria's ally Saxony, both forces of roughly army corps strength. These games, based on a set of ruled published by Wilhelm von Tschischwitz in 1867, involve about 40 participants. The setting allows for the depiction of different levels of command: each team is split into one army corps HQ and five division level commands, each with a separate map and set of tokens. Army corps commanders have to assess the situation, decide, and formulate orders according to the written messages they receive from division level commanders; this allows the depiction of several aspects of staff work in army corps level operations.
...
<iframe class="sozi" src="{{site.baseurl}}/assets/pres/maps_pres.sozi.html" style="height:576px;width:1024px;border:none;"></iframe>

### Tokens, units and formations in 1867
Military symbols in mid-19th century Prussia were quite different from modern NATO standard. Furthermore the rules take great care to distinguish and depict different tactical formations, often by representing single tactical units by multiple tokens defining how these have to be arranged to indicate a specific formation. Confusingly, a single tactical unit, like an infantry battalion or a gun battery are therefore represented by multiple tokens, even though they can not be split into independent sub units (Moving companies of infantry independently was in fact already an experimental feature of infantry tactics by 1866, but battalion lines were still standard practice). A quick overview of the unit types, symbols, and the ways tokens are used to represent different formations on the map can be seen at the picture below. A detailed presentation on how to use the contemporary unit tokens can be found here.
<iframe class="sozi" src="{{site.baseurl}}/assets/pres/tokens_pres.sozi.html" style="height:576px;width:1024px;border:none;"></iframe>

### Organising a corps level scenario
The Königgrätz scenario is large enough to simulate two levels of command on both sides. This requires some upscaling of the basic mechanisms, as teams have to be split and placed in more rooms, and despatches between command levels of the same team add to communication complexity.
A detailed presentation on the organisation of the Königgrätz game will follow soon.
